...
<head>
    ...
    <script src="../../../js/manage/emDetail.js"></script>
                                ...
                                <div class="img-grid">
                                    <div>
                                        ...
                                        <div class="img-box" id="id_box">
                                            <?php
                                            if(pathinfo("../../images/employee/$id_card/$pic_idcard")["extension"] != "pdf"){
                                            ?>
                                            <img id="img_id" <?php if($pic_idcard != ""){ echo "src='../../images/employee/$id_card/$pic_idcard'"; } ?>>
                                            <iframe  id="img_id" width="100%" height="100%" style="display:none;"></iframe>
                                            <?php
                                            }else{
                                            ?>
                                            <img id="img_id" style="display:none;">
                                            <iframe id="img_id" <?php if($pic_idcard != ""){ echo "src='../../images/employee/$id_card/$pic_idcard'"; } ?> width="100%" height="100%"></iframe>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="img-box" id="home_box">
                                            <?php
                                            if(pathinfo("../../images/employee/$id_card/$pic_home")["extension"] != "pdf"){
                                            ?>
                                            <img id="img_home" <?php if($pic_home != ""){ echo "src='../../images/employee/$id_card/$pic_home'"; } ?>>
                                            <iframe  id="img_home" width="100%" height="100%" style="display:none;"></iframe>
                                            <?php
                                            }else{
                                            ?>
                                            <img id="img_home" style="display:none;">
                                            <iframe id="img_home" <?php if($pic_home != ""){ echo "src='../../images/employee/$id_card/$pic_home'"; } ?> width="100%" height="100%"></iframe>
                                            <?php } ?>
                                        </div>
